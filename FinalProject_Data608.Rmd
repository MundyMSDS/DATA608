...
files <- dir("https://raw.githubusercontent.com/MundyMSDS/DATA608/master/", full.names = T) 

tcharts <- files %>%
  map(read_csv, col_names=c("trk","rnum","rprse","rdt","rdst","srf","pos","sxtnth","pgm","hrse","stime","sdst","srail","samph","sahd","ctime","cpk","cdst","cdlt","camph")) %>%     
  reduce(rbind) 
